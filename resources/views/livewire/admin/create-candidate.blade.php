<div>
    <div class="card" style="width:30%; margin-left:30%; margin-top:140px;  background-color:#54436B; border:none;"> 
        ...
        <div class="card-body">
            <label style="font-size:20px; margin-left:20px; magin-top:10px; color:white;">Name</label><br>
            <input type="text" wire:model="name"  class="form-control" style="width:80%; margin-left:30px;"><br>
            <label style="font-size:20px;  margin-left:20px; color:white;">Dept</label><br>
